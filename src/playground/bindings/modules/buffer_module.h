...
#ifndef PLAYGROUND_BINDINGS_MODULES_BUFFER_MODULE_H_
#define PLAYGROUND_BINDINGS_MODULES_BUFFER_MODULE_H_
...
// The filesystem module implements a sub-set of the Node.js Buffer API:
...
class BufferModule : public RuntimeModulator::SyntheticModule {
 public:
  BufferModule();
...
#endif  // PLAYGROUND_BINDINGS_MODULES_BUFFER_MODULE_H_
