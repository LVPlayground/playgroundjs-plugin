...
#ifndef PLAYGROUND_BINDINGS_MODULES_FS_MODULE_H_
#define PLAYGROUND_BINDINGS_MODULES_FS_MODULE_H_
...
// The filesystem module implements a sub-set of the Node.js File System API:
...
class FsModule : public RuntimeModulator::SyntheticModule {
public:
  FsModule();
  ~FsModule() override;
...
#endif  // PLAYGROUND_BINDINGS_MODULES_FS_MODULE_H_
